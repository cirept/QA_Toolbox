...
(function () {
    ...
    var checkLinks = {
        ...
        'showURL': function ($currentLink, isImageLink, $linkOverlay) {
            var linkURL = " "+jQuery.trim($currentLink.attr('href'));
            if(isImageLink) {
                if(!$($linkOverlay:contains(linkURL))) {
                    $linkOverlay.append(linkURL);
                }
            } else {
                if(!$($currentLink:contains(linkURL))) {
    ...
    var main = {
        ...
        'createElements': function () {
            main.config = {
                ...
                '$toolStyles': jQuery('<link>').attr({
                    'id': 'mycss',
                    'href': 'https://rawgit.com/cirept/QA_Toolbox/v1.96/assets/css/toolbox.css', // eslint-disable-line camelcase
                    'rel': 'stylesheet',
                    'type': 'text/css',
                }),
