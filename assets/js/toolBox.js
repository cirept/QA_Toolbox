...
(function () {
    ...
    var spellCheck = {
        ...
        'bannedWordsMap': function() {
            ...
            this.OEMap.set('Cadillac', ["Bargain", "Below invoice", "Blowout", "Clearance", "Close-out", "Dealer discounts available", "Dealer invoice", "Discount", "Factory-authorized sale", "Factory-authorized pricing", "Factory-to-dealer incentives", "Free", "Guaranteed low price", "Inventory reduction", "Invoice price", "Invoice sale", "Liquidation sale", "blowout sale", "inventory reduction sale", "Markdown", "Official lease termination center", "Outlet sales", "Overstocked", "Savings", "Special allocation", "Special purchase", "The price will never be lower", "We’ll finance anyone", "We’ll meet or beat any price", "We'll meet any price", "We'll beat any price", "Luxury for Less", "Free Maintenance", "Maintenance Free", "No Charge Maintenance", "Volume discount from Cadillac", "Volume discount from GM", "The Cadillac store", "The Cadillac outlet", "Cadillac’s official tri-county dealer", "Official lease termination center", "Official Cadillac service center", "Official GM service center", "Your exclusive Cadillac dealer", "We service all GM new vehicles"]);
            this.OEMap.set('Audi', ["Special Purchase", "Special Allocation", "Factory Authorized", "Factory-to-Dealer Incentives", "Overstocked", "Close-out", "Clearance", "Outlet Sales", "Liquidation", "Inventory Reduction", "Factory Lease Return Center", "biggest", "best", "largest", "first", "safest", "only"]);
            this.OEMap.set('BMW', ["clearance", "blowout", "closeout", "liquidation", "overstock", "inventory reduction", "below invoice"]);
            this.OEMap.set('Toyota', ["Public notice", "Factory allocation", "special allocation", "Factory challenged", "Factory authorized", "Special purchase", "Warehouse price", "warehouse store", "Authorized distribution center", "Close out", "Garage sale, blow out sale", "Good credit, bad credit–all applications accepted", "Inventory reduction", "Guaranteed lowest price", "Meet", "Liquidation", "No credit rejected", "W.A.C.", "O.A.C", "Overstocked", "Price protection guarantee", "We finance everyone", "Guaranteed credit approval", "Bad credit, no problem", "We won’t be undersold", "Beat"]);
            this.OEMap.set('Genesis', ["Guaranteed Lowest", "Price Price Protection Guarantee", "Liquidation", "We Finance Everyone", "No Credit Rejected", "Guaranteed Credit Approval", "Overstocked", "Bad Credit, No Problem", "We Won’t Be Undersold", "Blow Out Sale", "Inventory Reduction", "Good Credit, Bad Credit–All Applications Accepted", "Public Notice", "Authorized Distribution Center", "Factory Allocation", "Special Allocation", "Factory Challenged", "Warehouse Price", "Special Purchase", "Factory Authorized", "Garage Sale", "Above Cost", "Below Cost", "At Cost", "Warehouse Store", "Above Invoice", "Below Invoice", "At Invoice", "Low Price Guaranteed", "Liquidation", "As Seen On TV", "Rebate", "Cash Rebate", "Dealer Cost", "Retailer Cost", "Clearance", "Guaranteed Credit Approval", "Factory Invoice", "Everyone is approved", "Overstocked", "Inventory Reduction", "Will not be Undersold", "Volume Discount", "Finance Price", "Best price guaranteed", "Special Price", "Special Purchase", "Bailout", "Closeout", "Prices Slashed", "Undercut", "Meet", "Beat", "Match", "Best Prices", "Discounted Prices", "Outlet", "Sell Down"]);
            this.OEMap.set('Scion', ["Get e-price", "Quick Quote", "Request Price", "Click here for our lowest price", "Request Sales Price", "Sale Price", "Make an Offer", "Free (Price) Quote", "Free Quote", "Get Better than Internet Price"]);
            this.OEMap.set('Porsche', ["clearance", "vehicle discounts", "blow-out"]);
            this.OEMap.set('Mercedes-Benz', ["Blowout", "Cash Back", "Clearance", "Coupon", "Deal", "Dealer Cost", "Discount", "Factory Authorized", "Invoice", "Liquidation", "Lowest Price", "Meet", "Beat", "Overstocked", "Rebates", "Reduction", " Tent Sale", " Garage Sale", " Super Store", "Super Center", "$X Off", "% Off", "Save", "Savings", "Special Pricing", "Low Prices", "Price Guarantee"]);
            this.OEMap.set('Smart', ["Blowout", "Cash Back", "Clearance", "Coupon", "Deal", "Dealer Cost", "Discount", "Factory Authorized", "Invoice", "Liquidation", "Lowest Price", "Meet", "Beat", "Overstocked", "Rebates", "Reduction", " Tent Sale", " Garage Sale", " Super Store", "Super Center", "$X Off", "% Off", "Save", "Savings", "Special Pricing", "Low Prices", "Price Guarantee"]);
            this.OEMap.set('Maserati', ["Discount", "Sales Event", "On Sale", "Off MSRP", "Rebate", "Clearance", "Blow out", "Bailout", "Liquidation", "Wholesale", "Distress", "Factory Outlet", "Factory Authorized", "Manufacturer Challenged", "Factory Challenged", "Below Invoice", "Under Invoice", "blowout sale"]);
